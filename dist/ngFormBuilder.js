  ...
  app.run([
    ...
    function($templateCache) {
      ...
      $templateCache.put('formio/components/common/FAST.html',
        '<form-builder-fast></form-builder-fast>'
      );
    }
  ]);
};
...
},{"formiojs/utils":2,"lodash/get":176,"lodash/reject":202}],250:[function(_dereq_,module,exports){
"use strict";
module.exports = [
  function() {
    return {
...
app.directive('formBuilderFast', _dereq_('./directives/formBuilderFAST'));
/**
